(function (root) {
  ...
  function createSkillCatalogEngine(skillCatalog, storageKeys = defaultStorageKeys) {
  ...
  root.SkillSwapLearningData = {
    STORAGE_KEYS: defaultStorageKeys,
    createSkillCatalogEngine
  };
})(window);
